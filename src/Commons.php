...
class Commons {
    static function splitStringCases ($val) {
    ...
    static function pascalCase ($val) {
    ...
    static function snakeCase ($val) {
        $val = self::splitStringCases($val);
        return implode('_', $val);
    }

    static function kebabCase ($val) {
        $val = self::splitStringCases($val);
        return implode('-', $val);
    }
}
